      ...
      <main>
        <div class="row center">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <a href="product.html">
                <h2>Goodfellow & Co Men's Shirts</h2>
              </a>
              <div class="rating">
                <span>
                  <i class="fa fa-star"></i>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <a href="product.html">
                <h2>Brooks Brothers Slim Pants</h2>
              </a>
              <div class="rating">
                <span>
                  <i class="fa fa-star"></i>
